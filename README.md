...
This is Phase 1 (backend only). Potential future additions:

- Web-based UI for visual side-by-side comparison
- Highlighting diff regions on page images
...
A React-based web UI for visualizing PDF comparisons is available in the `ui/` directory.

See `ui/README.md` for setup instructions and implementation status.
...
Visit http://localhost:5173 to see the side-by-side PDF comparison with diff overlays.
